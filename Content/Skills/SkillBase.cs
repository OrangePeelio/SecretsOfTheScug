...
namespace SecretsOfTheScug.Skills
{
    public abstract class SkillBase<T> : SkillBase where T : SkillBase<T>
    {
        ...
        public SkillBase()
        {
            if (instance != null) throw new InvalidOperationException(
                $"Singleton class \"{typeof(T).Name}\" inheriting {ScugPlugin.modName} {typeof(SkillBase).Name} was instantiated twice");
            instance = this as T;
        }
    }
    ...
    {
        public static string Token = ScugPlugin.DEVELOPER_PREFIX + "SKILL";
        ...
        public Sprite LoadSpriteFromBundle(string name) { return assetBundle.LoadAsset<Sprite>(ScugPlugin.iconsPath + "Skill/" + name + ".png"); }
