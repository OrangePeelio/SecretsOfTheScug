...
namespace SecretsOfTheScug.Equipment
{
    ...
    public abstract class EquipmentBase : SharedBase
    {
        ...
        public static GameObject LoadDropPrefab(string prefabName = "")
        {
            ...
            if (ScugPlugin.mainAssetBundle && prefabName != "")
            {
                prefab = ScugPlugin.mainAssetBundle.LoadAsset<GameObject>($"Assets/Models/DropPrefabs/Item/{prefabName}.prefab");
            }
        ...
        public static GameObject LoadDisplayPrefab(string prefabName = "")
        {
            ...
            if (ScugPlugin.mainAssetBundle && prefabName != "")
            {
                prefab = ScugPlugin.mainAssetBundle.LoadAsset<GameObject>($"Assets/Models/DisplayPrefabs/Item/{prefabName}.prefab"); ;
            }
            return prefab;
        }
        ...
        {
            Sprite icon = null;
            if (ScugPlugin.mainAssetBundle && spriteName != "")
            {
                icon = ScugPlugin.mainAssetBundle.LoadAsset<Sprite>($"Assets/Textures/Icons/Item/{spriteName}.png");
            }
