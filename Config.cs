...
namespace SecretsOfTheScug
{
    ...
    public static class Config
    {
        ...
        {
            MyConfig = new ConfigFile(Paths.ConfigPath + $"\\{CriticalBlock.PluginGUID}.cfg", true); //FortunesPlugin.instance.Config;
            BackupConfig = new ConfigFile(Paths.ConfigPath + $"\\{CriticalBlock.PluginGUID}.Backup.cfg", true);
