...
namespace SecretsOfTheScug
{
    ...
    public static class Config
    {
        ...
        {
            MyConfig = new ConfigFile(Paths.ConfigPath + $"\\{SecretsOfTheScug.PluginGUID}.cfg", true); //FortunesPlugin.instance.Config;
            BackupConfig = new ConfigFile(Paths.ConfigPath + $"\\{SecretsOfTheScug.PluginGUID}.Backup.cfg", true);
