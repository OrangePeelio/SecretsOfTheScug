...
namespace SecretsOfTheScug.Modules
{
    ...
    public static class Config
    {
        ...
        {
            MyConfig = new ConfigFile(Paths.ConfigPath + $"\\{ScugPlugin.guid}.cfg", true); //ScugPlugin.instance.Config;
            BackupConfig = new ConfigFile(Paths.ConfigPath + $"\\{ScugPlugin.guid}.Backup.cfg", true);
